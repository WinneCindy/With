...
#define URL_HEADURLInfo @"https://www.with17.cn"
...
- (void)setAvatarByMessage:(NIMMessage *)message
{
    ...
    NSURL *url = info.avatarUrlString ? [NSURL URLWithString:[NSString stringWithFormat:@"%@%@",URL_HEADURLInfo, info.avatarUrlString]] : nil;
