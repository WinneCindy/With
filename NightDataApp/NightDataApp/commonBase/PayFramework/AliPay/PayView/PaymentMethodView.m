...
- (void)LayoutUIs
{
    ...
    self.weichatPayBtn = [self setPayMentBtnWithTitle:@"微信支付" andBackGroundColor:Color_Gold];
    
    self.aliPayBtn = [self setPayMentBtnWithTitle:@"支付宝支付" andBackGroundColor:Color_Gold];
    
    [titleLab mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo (self.mas_top).offset (16*SCREEN_HEIGHT/667);
    ...
    [_weichatPayBtn.titleLabel setFont:[UIFont systemFontOfSize:14]];
    [_weichatPayBtn.layer setCornerRadius:5];
    ...
    [_aliPayBtn.titleLabel setFont:[UIFont systemFontOfSize:14]];
    
     [_aliPayBtn.layer setCornerRadius:5];
}
...
- (void)returnToPayView {
    ...
    [UIView animateWithDuration:0.5 animations:^{
        weakSelf.frame = CGRectMake(SCREEN_WIDTH, 0, SCREEN_WIDTH, weakSelf.frame.size.height);
