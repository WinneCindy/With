...
-(UIView *)initWithFrame:(CGRect )frame andNSString:(NSString *)title canUseMoney:(BOOL)money;
{
    ...
    if (self) {
        ...
        [self layOutUIWith:title canUser:money];
    }
    return self;
}
...
- (void)upDownSelf {
    ...
    [UIView animateWithDuration:0.5 animations:^{
        ...
        weakSelf.payMentView.frame = CGRectMake(SCREEN_WIDTH, 0, SCREEN_WIDTH, payViewHeight);
    }];
}
...
- (void)nextBtnClick:(UIButton *)sender
{
    ...
    __weak PayView *weakSelf = self;
    [UIView animateWithDuration:0.5 animations:^{
        weakSelf.payMentView.frame = CGRectMake(0, 0, SCREEN_WIDTH, payViewHeight);
    } completion:^(BOOL finished) {
...
- (void)layOutUIWith:(NSString *)title canUser:(BOOL)money{
    ...
    self.priceLabel.textColor = Color_Gold;
    ...
    if (money) {
        ...
        [_walltBtn setImage:[UIImage imageNamed:@"Xhao"] forState:UIControlStateNormal];
    }
    ...
    _paymentLable.text = @"支付宝";
    _paymentLable.textAlignment = NSTextAlignmentRight;
...
//    _nextBtn.backgroundColor = [UIColor yellowColor];
    ...
    _online.backgroundColor = Color_Gold;
    ...
    [_headTitleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo (_backgroungView.mas_top).offset (16*SCREEN_HEIGHT/667);
        make.centerX.mas_equalTo(_backgroungView.mas_centerX);
        make.height.mas_equalTo (16*SCREEN_HEIGHT/667);
    }];
    ...
    [nameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo (line.mas_bottom).offset (25*SCREEN_HEIGHT/667);
        make.left.mas_equalTo (_backgroungView.mas_left);
    ...
    [_creditBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(15*SCREEN_HEIGHT/667);
    }];
    ...
    [_online mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo (_backgroungView.mas_right).offset (-10);
        make.height.mas_equalTo (46*SCREEN_HEIGHT/667);
...
- (void)loadPayMentView {
    self.payMentView = [[PaymentMethodView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH, 0, SCREEN_WIDTH, payViewHeight)];
